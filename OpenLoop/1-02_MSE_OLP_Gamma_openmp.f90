program runreservoir
  ...
  do iab = 1, Na*Nb
    ...
    !$omp parallel
    !$omp do private(ith,W_in,i_ens,i,k,M,Mtemp,r1,r2,r1s,r2s,Z1,Z2,RR,RY,IPIV,WORK,INFO,ti,X1p,X2p)
    do i_ens = 1, N_ens
    ...
    write ( filepath, '( A, I4.4, A, I3.3, A, I3.3, A )' ) &
      '../data/MSE_OLP_Nres', N_res, '_GammaM_tanhr_J0J_Linear/ia', ia, '_ib', ib, '.dat'
