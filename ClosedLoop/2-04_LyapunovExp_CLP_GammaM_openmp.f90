program runreservoir
  ...
  real        (8) :: shapek, theta, aGamma=0.0d0, J0, J, unorm, LEs ( N_ens ), mean1, var1
  ...
  do iab = 1, Na*Nb
    ...
    !$omp parallel
    !$omp do private(ith,W_in,i_ens,i,k,M,Mtemp,r,rs,Z,RR,RY,IPIV,WORK,INFO,u,ti,JM,unorm,tanhr,X1p)
    do i_ens = 1, N_ens
    ...
    write ( filepath, '( A, I4.4, A, I3.3, A, I3.3, A )' ) &
      '../data/LyapunovExp_period1e4_CLP_Nres', N_res, '_regpexp-2_GammaM_tanhr_J0J_Linear/ia', ia, '_ib', ib, '.dat'
